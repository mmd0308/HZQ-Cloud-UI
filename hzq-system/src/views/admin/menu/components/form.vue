    ...
    <div class="menu-form">
      ...
      <el-form :ref="dataFormRef" :rules="rules" :model="menuForm" label-position="left" label-width="120px" style="margin:0px 50px;">
        <el-form-item label="角色名称" prop="name">
          <el-input v-if="formStatus === 'see'" :disabled="true" v-model="menuForm.name" placeholder="请输入角色名称" />
          <el-input v-else v-model="menuForm.name" placeholder="请输入角色名称" />
        </el-form-item>
        ...
        <el-form-item label="是否显示" prop="show_flag">
        ...
        <el-form-item label="权限编码" prop="permission">
          <el-input v-if="formStatus === 'see'" :disabled="true" v-model="menuForm.permission" placeholder="请输入链接" />
          <el-input v-else v-model="menuForm.permission" placeholder="请输入链接" />
        </el-form-item>
        <el-form-item label="排序" prop="sort">
          <el-input v-if="formStatus === 'see'" :disabled="true" v-model="menuForm.sort" placeholder="请输入链接" />
          <el-input v-else v-model="menuForm.sort" placeholder="请输入链接" />
        </el-form-item>
